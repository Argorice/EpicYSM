...
public final class EpicFightItems {
    ...
    public static boolean drawAt(AbstractClientPlayer player, PoseStack poseStack, MultiBufferSource buffers,
        ...
        try {
            ...
            boolean valid = off ? patch.isOffhandItemValid() : !patch.getValidItemInHand(InteractionHand.MAIN_HAND).isEmpty();
            ...
            renderer = yesman.epicfight.client.ClientEngine.getInstance().renderEngine.getItemRenderer(stack);
