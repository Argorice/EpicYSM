...
Run from this folder: python3 make_branding.py ["Minecraft 1.20.1  ·  Forge  ·  client side"]"""
import math
import sys
from PIL import Image, ImageChops, ImageDraw, ImageFilter, ImageFont

PLATFORM = sys.argv[1] if len(sys.argv) > 1 else "Minecraft 1.21.1  ·  NeoForge  ·  client side"
...
def banner(w=1280, h=640):
    ...
    try:
        ...
        pass
    d.text((x + 8, ty + 158), PLATFORM, font=small, fill=(200, 185, 210))
    return img
